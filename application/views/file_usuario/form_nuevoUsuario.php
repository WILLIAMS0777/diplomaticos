		    		...
		    		<div class="container-fluid">
		    			<div class="row">
							...
							<div class="col-lg-3">
								<div class="from-group">
									<label>USUARIO</label>
									<input type="text" name="usuario" id="usuario" onkeyup="verificar_usuarios(this.value)" class="form-control" required placeholder="Ingresar usuario...">
									<i id="error"></i>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="from-group">
									...
									<input type="password" name="password" id="password" class="form-control" required placeholder="Ingresar password...">
								</div>
							</div>
							<div id="valores">
...
<script>
	function verificar_usuarios(user){
		...
		$.post('verificar_usuarios', {user}, function(data){
			...
			if (valores[0]===1) {
				$("#error").html('<b style="color:#ff0000">El usuario ya existe');
				document.getElementById('boton').disabled=true;
			}else{
				$("#error").html('<b style="color:#008000">El usuario no existe');
