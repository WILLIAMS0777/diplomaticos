...
//MakeFont('castelar.ttf','castelar.afm','makefont/cp1252');
...
class FPDF {
    ...
    function FPDF($orientation='P', $unit='mm', $size='A4'){
        ...
        elseif (is_dir(dirname(__FILE__) . '/font'))
            ...
            $this->fontpath = '';
        // Core fonts
        $this->CoreFonts = array('courier', 'helvetica', 'times', 'symbol', 'zapfdingbats','monotypecorsiva','Castellar');
        // Scale factor
        if ($unit == 'pt')
            $this->k = 1;
        elseif ($unit == 'mm')
    ...
    function AddPage($orientation = '', $size = '') {
        ...
        if ($family)
			...
			$this->AddFont('monotypecorsiva','B','monotypecorsiva.php');
			$this->AddFont('Castellar','B','Castellar.php');
		...
		//MakeFont('seattle_sans_regular.ttf','seattle.afm','cp1252');
        // Restore font
        if ($family)
            $this->SetFont($family, $style, $fontsize);
        // Restore colors
    ...
    function Output($name = '', $dest = '',$rgs='') {
        //metodo del limpieza del cache
        ob_end_clean();
...
// End of class
    ...
    function Row($data) {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $this->Rect($x, $y, $w, $h);
            //Print the text 
            $this->MultiCell($w, 4, $data[$i], 'LTR', $a, false);
...
//ENCABEZADO
    function Header() {
        //$modulo = $_SESSION['encabezado'];
        //$modulo = ' ';
        //$this->$modulo();
            //$this->ln(2);
        //$this->SetTextColor(0,51,102);
        //$this->Image('img/upea.jpg' ,20 ,11,30 ,30,'JPG','');
               // $this->Image('img/upea.png' ,100 ,7,22 ,24,'png','');
        //cabecera AddPage
        //$this->SetTextColor(0,51,102);
//        $this->SetFont('monotypecorsiva', 'B', 23);
        ...
        //$this->SetFont('Arial', 'B', 16);
               //$this->Ln(8);
        //$this->Cell(0,5,'VICERRECTORADO1111',0,1,'C');
        //$this->Cell(0,3,'Creada por Ley N 2115 del 15 de Septiembre de 2000',0,1,'C');
        // $this->Cell(0,3,'','T',1,'L');
                //$this->Ln(2);
    }
    function Header1() {
	...
	function Header2() {
		...
		/*$this->ln(2);
		$this->SetTextColor(0,51,102);
		//$this->Image('img/upea.jpg' ,20 ,7,22 ,24,'JPG','');
		//cabecera AddPage
		$this->SetTextColor(0,51,102);
		...
		$this->SetFont('Times', 'BI', 8);
		//$this->Cell(0,3,utf8_decode('Creada por Ley Nº 2115 de 05 de Septiembre de 2000'),0,1,'C');
        //$this->Cell(0,3,utf8_decode('Autónoma por Ley Nº 2556 de 12 de Noviembre de 2003'),0,1,'C');
		$this->SetFont('Arial', 'B', 16);
		//$this->Cell(0,5,'VICERRECTORADO',0,1,'C');
		//$this->Cell(0,3,'','T',1,'L');
		$this->Ln(15);
            $this->Ln(2);*/
    }
    function licencia_docente() {
   ...
   return $diasmes;
    ...
    function Footer() {
        ...
        $this->Cell(80,8,'Unidos todos por la institución  ','T',0,'L');
        $this->Cell(80,8,'TRANS. "DIPLOMÁTICOS" '.date('d/m/Y H:i:s'),'T',0,'C');

        $this->Cell(30, 5, ' Pag. ' . $this->PageNo() . '', 0, 1, 'R');
        // $this->ln(5);
        // $this->Cell(180,4,'http://www.fundacionperceptor.org',1,0,'L');
    }
	function Footer2() {
        /*$this->SetY(-20);
        $this->SetFont('Arial', 'I', 9);
        ...
        $this->SetTextColor(128);
        //$this->Cell(80,8,'Sistema de Control y Certificacion "SiCC"  ','T',0,'L');
        //$this->Cell(50,8,'@Rgs:'.date('d/m/Y H:i:s'),'T',0,'C');
...
//implementacion de restricciones en pdf 
...
///////////////casos de  encajonamiento de txtos 
//Cell with horizontal scaling if text is too wide
    ...
    /**
* Este script cambia el tamaño de letra para que el texto se
* ajuste al tamaño de la celda.
*
* Despues de escribir el texto, se restaura el tamaño de letra inicial.
*
* Se usa igual que la funcion cell()
*
* @author Luis Paez Rocha
*/
function AjustaCelda($ancho, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $scale=false, $force=true) {
  ...
  while($this->GetStringWidth($txt) > $ancho){
    ...
    $this->Cell($ancho, $h, $txt, $border, $ln, $align, $fill, $link);
